...
export default function MySkill() {
  return (
    ...
    <section className="w-full px-4 md:px-8 lg:px-12 pt-25 bg-gradient-to-r from-purple-50 via-pink-50 to-orange-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
